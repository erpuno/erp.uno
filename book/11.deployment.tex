...
\begin{itemize}
    ...
    \item \texttt{clearance-abac} --- Go-сервер для авторизації, перевірки допусків та збору аудит-логів доступу.
...
\hline
\textbf{Компонент} & \textbf{Призначення} & \textbf{Протокол} & \textbf{Порт} & \textbf{Тип} \\ \hline
\texttt{ns-dns} & DNS-сервер & UDP/TCP & 53 & Stateful \\ \hline
\texttt{ca-pki} & Локальний PKI & TCP & 8045 & Stateful \\ \hline
\texttt{vpn-wireguard} & VPN-шлюз & UDP & 51820 & Stateful \\ \hline
\texttt{ldap-directory} & ABAC-директорія & TCP & 389/636 & Stateful \\ \hline
\texttt{ias-auth} & Авторизація & TCP & 8080 & Stateless \\ \hline
\texttt{chat-messenger} & WebSocket брокер & TCP & 8830 & Stateless \\ \hline
\texttt{mail-delivery} & SMTP/IMAP сервер & TCP & 8043 & Stateless \\ \hline
\texttt{rest-bpe} & BPE REST API & TCP & 8090 & Stateless \\ \hline
\texttt{clearance-abac} & Мандати та аудит & TCP & 8085 & Stateless \\ \hline
\texttt{mach-ivr} & Телефонія IVR & TCP & 8086 & Stateless \\ \hline
\texttt{bpe-engine} & Рушій процесів BPMN & TCP & 8087 & Stateless \\ \hline
\texttt{kvs-database} & Сховище KVS & TCP & 8088 & Stateful \\ \hline
\texttt{nitro-portal} & Веб-інтерфейс & TCP & 8089 & Stateless \\ \hline
\texttt{n2o-server} & WebSocket-сервер додатків & TCP & 8091 & Stateless \\ \hline
\texttt{faiss-search} & Векторний пошук & TCP & 8092 & Stateless \\ \hline
\texttt{crm-documents} & Управління документами & TCP & 8050 & Stateless \\ \hline
\texttt{itsm-incidents} & Диспетчер інцидентів & TCP & 8053 & Stateless \\ \hline
\texttt{prometheus} & Моніторинг метрик & TCP & 9090 & Stateful \\ \hline
\texttt{grafana} & Дашборди метрик & TCP & 3000 & Stateless \\ \hline
\texttt{loki} & Збір логів додатків & TCP & 3100 & Stateful \\ \hline
\texttt{otel-collector} & OpenTelemetry шлюз & TCP/UDP & 4317/4318 & Stateless \\ \hline
\end{tabular}
\end{adjustwidth}
...
\texttt{zencrypted/clearance} & \texttt{clearance-abac} \\ \hline
