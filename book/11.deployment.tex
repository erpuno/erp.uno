...
\texttt{ns-nameserver} & \texttt{root-infra} & DNS-сервер дозволу імен & 53:8101 & Є \\ \hline
\texttt{vpn-wireguard} & \texttt{root-infra} & VPN-шлюз міжнодового зв'язку & 51820:8102 & Є \\ \hline
...
\texttt{abac-clearance} & \texttt{security} & Мандати та аудит логів доступу & 8203 & Нема \\ \hline
\texttt{ias-authorization} & \texttt{security} & Автентифікація користувачів & 8204 & Нема \\ \hline
\texttt{kvs-database} & \texttt{database} & Розподілене сховище KVS & 8301 & Є \\ \hline
\texttt{bpe-workflow} & \texttt{database} & Рушій процесів BPMN & 8302 & Нема \\ \hline
...
\texttt{pm-projects} & \texttt{erp} & Управління задачами та Wiki & 8514 & Є \\ \hline
\hline
