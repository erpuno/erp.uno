...
% Define TIKZ settings (if diagrams are present)
...
\color{white}\thispagestyle{empty}\vspace*{3cm}\centering
  ...
  {\LARGE \textbf{ на створення та впровадження \\
                   локальної системи безпечного зв'язку, \\
                   видачі сертифікатів та обміну повідомленнями} \par} \vspace{1.5cm}
  {\large Згідно з Постановою КМУ № 205 від 21.02.2025 \par}
  {\large Формалізація вимог за стандартом ISO/IEC/IEEE 29148:2018 \par} \vfill
  {\large 2026 \copyright\ Системи Електронного Урядування \par}
\end{titlepage}

\newpage

\begin{center} {\Huge\color{primary}\bfseries Зміст\par} \end{center} \vspace{40pt}
...
\textbf{Найменування засобу інформатизації:} Модуль «Комунікатор» (інфраструктура безпечного зв'язку CHAT v2 / MAIL v3)
у складі інформаційної системи управління підприємством ERP/1.
...
Модуль призначений для розгортання периферійних систем захищеного обміну повідомленнями та документами,
локального управління сертифікатами відкритих ключів (CA), VPN-тунелювання, служби каталогів (LDAP) та
Identity Access Management (IAS) без використання сторонніх хмарних рішень та мови Rust на периферії.
...
\begin{enumerate}
    ...
    \begin{itemize}
        ...
        \item \texttt{zencrypted/vpn/} --- Модулі VPN тунелів.
