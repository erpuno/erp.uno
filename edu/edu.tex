...
\subsubsection{3.1.4. Вимоги до протоколів взаємодії}
...
\subsubsection{3.1.5. Опис прав та привілеїв (ABAC/RBAC/ACL)}
...
\subsubsection{3.1.6. Опис валідацій}
...
\subsubsection{3.1.7. Шаблони сповіщень}
...
\subsubsection{3.1.8. Вимоги до серіалізації}
...
\subsubsection{3.1.9. Вимоги до транспорту}
...
\subsubsection{3.2.3. Вимоги до потужності і ємності}
...
\subsubsection{3.2.5. Адміністративні вимоги}
\begin{itemize}
...
\subsubsection{3.2.6. Загальні вимоги до документації та артефактів}
...
\subsubsection{3.2.7. Юридичні вимоги}
\begin{itemize}
