...
\fancyfoot[L]{\small\color{footergray} Техноробочий проект ЄСІКС. Модуль Освіта}
...
\\
\textbf{Відомості про замовника:} Державна судова адміністрація України в особі ДП «Інформаційні Судові Системи».
\\
...
\begin{itemize}
    ...
    \item Програма інформатизації ЄСІКС.
\end{itemize}
...
\begin{itemize}
    ...
    \item \textbf{База даних:} Вбудована СУБД Erlang Mnesia. Виключається використання будь-яких сторонніх SQL СУБД (PostgreSQL, MySQL, SQLite) для підвищення продуктивності та відмовостійкості.
