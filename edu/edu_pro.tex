...
\subsubsection{Процес оцінювання (Student Assessment FSM)}
...
\subsubsection{Процес проведення занять (Lesson Execution)}
\begin{enumerate}
...
\subsubsection{Затвердження навчального плану (Curriculum Approval)}
\begin{enumerate}
...
\subsubsection{Генерація розкладу занять (Schedule Generation)}
\begin{enumerate}
...
\subsubsection{Алгоритми конвертації оцінок}
...
\subsubsection{bpe\_education\_assessment.erl (DSL процесу оцінювання)}
...
\subsubsection{bpe\_education\_lesson.erl (DSL процесу проведення заняття)}
\begin{verbatim}
...
\subsubsection{bpe\_curriculum\_approval.erl (DSL затвердження навчального плану)}
\begin{verbatim}
...
\subsubsection{bpe\_schedule\_generation.erl (DSL генерації розкладу)}
\begin{verbatim}
...
\subsubsection{grade\_validator.erl (Модуль валідації надійності даних та оцінок)}
