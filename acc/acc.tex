...
\subsection{2.1. Передумови розробки}
...
\subsection{2.2. Законодавча основа}
...
\subsection{3.1. Функціональні вимоги}

\subsubsection{3.1.1. Опис довідників}
...
\subsubsection{3.1.2. Опис реєстрових сутностей та їх станів}
...
\subsubsection{3.1.3. Опис бізнес-процесів}
...
\subsubsection{3.1.4. Опис модулів інтерфейсу клієнта}
...
\subsubsection{3.1.5. API та протоколи взаємодії}
...
\subsubsection{3.1.6. Рольова модель та ABAC правила}
...
\subsubsection{3.1.7. Опис валідацій}
...
\subsubsection{3.1.8. Шаблони сповіщень та документів}
\begin{itemize}
...
\subsubsection{3.1.9. Вимоги до серіалізації}
...
\subsubsection{3.1.10. Вимоги до транспорту}
Безпечна взаємодія через HTTPS/WSS/MQTT з використанням протоколу шифрування TLS 1.3.

\subsection{3.2. Нефункціональні вимоги}

\subsubsection{3.2.1. Вимоги до архітектури}
...
\subsubsection{3.2.2. Вимоги до безпеки}
\begin{itemize}
...
\subsubsection{3.2.3. Вимоги до продуктивності}
\begin{itemize}
...
\subsubsection{3.2.4. Вимоги до функціональності логування}
Ведення Audit Log у форматі JSON з експортом до стеку ELK (Filebeat, Logstash, Elasticsearch, Kibana).

\subsubsection{3.2.5. Тестування та супровід}
\begin{itemize}
