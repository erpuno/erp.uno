...
\subsubsection{2.1.1. Процес проводки первинного документа}
\begin{enumerate}
...
\subsubsection{2.1.2. Процес розрахунку заробітної плати}
\begin{enumerate}
...
\subsubsection{2.1.3. Процес планування закупівель}
\begin{enumerate}
...
\subsubsection{2.1.4. Процес підготовки та подання звітності}
\begin{enumerate}
...
\subsection{2.3. Умови експлуатації}
\begin{itemize}
...
\subsection{3.1. Інформаційне забезпечення (Реквізити)}
...
\subsubsection{3.2.1. bpe\_bookkeeping\_posting.erl (Процес проведення документа)}
\begin{verbatim}
...
\subsubsection{3.2.2. bpe\_payroll\_calculation.erl (Процес розрахунку ЗП)}
\begin{verbatim}
...
\subsubsection{3.2.3. bpe\_procurement\_planning.erl (Процес планування закупівель)}
\begin{verbatim}
...
\subsubsection{3.2.4. acc\_validator.erl (Модуль бізнес-валідацій)}
\begin{verbatim}
...
\subsection{4.4. Вимоги до продуктивності}
\begin{itemize}
...
\subsection{4.5. Вимоги до логування, тестування та супроводу}
\begin{itemize}
