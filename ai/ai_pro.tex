...
\color{white}\thispagestyle{empty}\vspace*{3cm}\centering
  ...
  {\LARGE \textbf{на створення та впровадження модуля «Істотність» \\ (локальної ШІ-інфраструктури)} \par} \vspace{1.5cm}
  {\large Згідно з ДСТУ 34.201-89 та Порядком використання засобів інформатизації \par}
