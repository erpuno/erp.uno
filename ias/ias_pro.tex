...
\begin{itemize}
    ...
    \item Категорична відмова від використання JSON Web Tokens (JWT) та OpenID Connect (OIDC) як основних засобів автентифікації. Замість цього застосовується криптоцентрична архітектура на базі mTLS X.509 та локальної генерації CSR на пристроях відповідно до \cite{jwt_pdf, openid_pdf}.
...
\bibitem{jwt_pdf} 
Технічні вимоги: Про неприпустимість використання JWT токенів як самостійного механізму в державних системах, 2026. 
\url{https://5ht.co/jwt.pdf}

\bibitem{openid_pdf} 
Технічні вимоги: Щодо неприпустимості використання OpenID Connect токенів при наявності eIDAS/EUDI у вимогах, 2026. 
\url{https://5ht.co/openid.pdf}
\end{thebibliography}
